        ...
        <section className="relative overflow-hidden py-24 sm:py-32">
          ...
          <div className="container mx-auto px-4 sm:px-6 text-center max-w-4xl space-y-8">
            ...
            <p className="mx-auto max-w-2xl text-lg text-muted-foreground leading-relaxed">
              A secure, role-based dashboard application tailored for students, lecturers, and administrators. Manage courses, track performance, and directory lists in real-time.
            </p>
      ...
      <footer className="border-t border-border/40 py-8 bg-card">
        <div className="container mx-auto px-4 sm:px-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left">
          ...
          <div className="flex gap-4 text-xs text-muted-foreground">
            ...
            <span className="font-mono">Press <kbd className="px-1 py-0.5 rounded-sm border bg-muted">d</kbd> to toggle themes</span>
          </div>
        </div>
      </footer>
    </div>
